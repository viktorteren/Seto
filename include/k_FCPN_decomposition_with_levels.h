...
class k_FCPN_decomposition_with_levels {
private:
    ...
    int regions_in_solution;
    vector<vector<int32_t> *> *clauses;
    map<int, set<set<Region *>*>*> *cnf_ec_map;
    set<pair<Region *, Region *>> *regions_in_conflict;
    map<int, set<Region*>*> *state_regions_map;
    void compute(const string& file, Pre_and_post_regions_generator *pprg);

public:
    k_FCPN_decomposition_with_levels(int number_of_events,
                         set<Region*> *regions,
                         const string& file,
                         Pre_and_post_regions_generator *pprg,
                         map<int, int> *aliases,
                         map<int, ER> *ER);
    ~k_FCPN_decomposition_with_levels();
};