...
namespace Utilities {
    ...
    vec<vec<int>*>* add_regions_clauses_to_solver(Solver& s, map<int, set<Region *> *> *regions_map, set<int>& uncovered_states); //s vill recieve new clauses and uncovered_states the states to cover
